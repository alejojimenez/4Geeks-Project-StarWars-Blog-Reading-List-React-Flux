...
const CardDetail2 = () => {
    ...
    console.log('---Store---', store.cardDetailVehicle)

    return (
        <>
            <br></br>
            <Card style={{ width: '60rem', height: '60rem' }}>
                <Image variant="left" src="https://hipertextual.com/files/2019/12/hipertextual-mira-diseno-final-nave-porsche-star-wars-ascenso-skywalker-2019401507-scaled.jpg" />
                <Card.Body>
                    <Card.Title>{store.cardDetailVehicle.model} {id}</Card.Title>
